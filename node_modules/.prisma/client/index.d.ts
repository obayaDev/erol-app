...
export namespace Prisma {
  ...
  */
  ...
  export type branchesSelect = {
    ...
    events?: boolean | branches$eventsArgs
  ...
  export class Prisma__branchesClient<T, Null = never> implements Prisma.PrismaPromise<T> {
    ...
    events<T extends branches$eventsArgs= {}>(args?: Subset<T, branches$eventsArgs>): Prisma.PrismaPromise<Array<eventsGetPayload<T>>| Null>;
   ...
   * branches.events
   */
  export type branches$eventsArgs = {
    /**
  ...
  export type childsGetPayload<S extends boolean | null | undefined | childsArgs> =
    ...
    : S extends { select: any } & (childsArgs | childsFindManyArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
        P extends 'branch' ? branchesGetPayload<S['select'][P]> :  P extends keyof childs ? childs[P] : never
  } 
      : childs
  ...
  export type eventsGetPayload<S extends boolean | null | undefined | eventsArgs> =
    ...
    : S extends { select: any } & (eventsArgs | eventsFindManyArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
        P extends 'branch' ? branchesGetPayload<S['select'][P]> :  P extends keyof events ? events[P] : never
  } 
      : events
  ...
  export type forms_sleepGetPayload<S extends boolean | null | undefined | forms_sleepArgs> =
    ...
    ? forms_sleep  & {
    [P in TruthyKeys<S['include']>]:
        P extends 'confirmed_by' ? UserGetPayload<S['include'][P]> :  never
  } 
    : S extends { select: any } & (forms_sleepArgs | forms_sleepFindManyArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
        P extends 'confirmed_by' ? UserGetPayload<S['select'][P]> :  P extends keyof forms_sleep ? forms_sleep[P] : never
  } 
      : forms_sleep
  ...
  export type childsWhereInput = {
    ...
    father_id?: IntFilter | number
    mother_id?: IntFilter | number
  ...
  export type childsScalarWhereWithAggregatesInput = {
    ...
    father_id?: IntWithAggregatesFilter | number
    mother_id?: IntWithAggregatesFilter | number
  ...
  export type eventsScalarWhereWithAggregatesInput = {
    ...
    past?: BoolWithAggregatesFilter | boolean
  ...
  export type forms_sleepWhereInput = {
    ...
    userId?: IntFilter | number
    confirmed_by?: XOR<UserRelationFilter, UserWhereInput>
  }
  ...
  export type eventsCreateInput = {
    ...
    branch: branchesCreateNestedOneWithoutEventsInput
  }
  ...
  export type eventsUpdateInput = {
    ...
    assistence?: JsonNullValueInput | InputJsonValue
    branch?: branchesUpdateOneRequiredWithoutEventsNestedInput
  }
  ...
  export type forms_sleepUpdateInput = {
    ...
    confirmed_by?: UserUpdateOneRequiredWithoutForms_sleepNestedInput
  }
  ...
  export type eventsCreateNestedManyWithoutBranchInput = {
    create?: XOR<Enumerable<eventsCreateWithoutBranchInput>, Enumerable<eventsUncheckedCreateWithoutBranchInput>>
    connectOrCreate?: Enumerable<eventsCreateOrConnectWithoutBranchInput>
  ...
  export type eventsUpdateManyWithoutBranchNestedInput = {
    create?: XOR<Enumerable<eventsCreateWithoutBranchInput>, Enumerable<eventsUncheckedCreateWithoutBranchInput>>
    connectOrCreate?: Enumerable<eventsCreateOrConnectWithoutBranchInput>
    upsert?: Enumerable<eventsUpsertWithWhereUniqueWithoutBranchInput>
    createMany?: eventsCreateManyBranchInputEnvelope
    ...
    connect?: Enumerable<eventsWhereUniqueInput>
    update?: Enumerable<eventsUpdateWithWhereUniqueWithoutBranchInput>
    updateMany?: Enumerable<eventsUpdateManyWithWhereWithoutBranchInput>
  ...
  export type branchesCreateNestedOneWithoutEventsInput = {
    create?: XOR<branchesCreateWithoutEventsInput, branchesUncheckedCreateWithoutEventsInput>
    connectOrCreate?: branchesCreateOrConnectWithoutEventsInput
    connect?: branchesWhereUniqueInput
  }
  ...
  export type branchesUpdateOneRequiredWithoutEventsNestedInput = {
    create?: XOR<branchesCreateWithoutEventsInput, branchesUncheckedCreateWithoutEventsInput>
    connectOrCreate?: branchesCreateOrConnectWithoutEventsInput
    upsert?: branchesUpsertWithoutEventsInput
    connect?: branchesWhereUniqueInput
    update?: XOR<branchesUpdateWithoutEventsInput, branchesUncheckedUpdateWithoutEventsInput>
  }
  ...
  export type UserUpdateOneRequiredWithoutForms_sleepNestedInput = {
    create?: XOR<UserCreateWithoutForms_sleepInput, UserUncheckedCreateWithoutForms_sleepInput>
    connectOrCreate?: UserCreateOrConnectWithoutForms_sleepInput
  ...
  export type eventsCreateManyBranchInputEnvelope = {
    data: Enumerable<eventsCreateManyBranchInput>
    skipDuplicates?: boolean
  }
  ...
  export type branchesCreateWithoutEventsInput = {
    name: string
    branch: string
    year_in: number
    year_out: number
  ...
  export type branchesUncheckedCreateWithoutEventsInput = {
    id?: number
    name: string
    branch: string
    year_in: number
  ...
  export type branchesCreateOrConnectWithoutEventsInput = {
    where: branchesWhereUniqueInput
    create: XOR<branchesCreateWithoutEventsInput, branchesUncheckedCreateWithoutEventsInput>
  }

  export type branchesUpsertWithoutEventsInput = {
    update: XOR<branchesUpdateWithoutEventsInput, branchesUncheckedUpdateWithoutEventsInput>
    create: XOR<branchesCreateWithoutEventsInput, branchesUncheckedCreateWithoutEventsInput>
  }

  export type branchesUpdateWithoutEventsInput = {
    name?: StringFieldUpdateOperationsInput | string
    branch?: StringFieldUpdateOperationsInput | string
    year_in?: IntFieldUpdateOperationsInput | number
    year_out?: IntFieldUpdateOperationsInput | number
  ...
  export type branchesUncheckedUpdateWithoutEventsInput = {
    id?: IntFieldUpdateOperationsInput | number
    name?: StringFieldUpdateOperationsInput | string
    branch?: StringFieldUpdateOperationsInput | string
    year_in?: IntFieldUpdateOperationsInput | number
